...
public class InvestimentoView {
    ...
    public InvestimentoView() throws UnsupportedEncodingException {
        this.scanner = new Scanner(System.in);
        configurarCodificacao();
    }

    private void configurarCodificacao() throws UnsupportedEncodingException {
        // Configura a codificação para UTF-8 (solução para Windows)
