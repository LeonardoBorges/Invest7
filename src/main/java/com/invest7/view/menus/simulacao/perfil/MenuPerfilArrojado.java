...
public class MenuPerfilArrojado {
    ...
    public void simulacaoPerfilArrojado(Double capital, int reinvestir, int prazo, double aporte, int quantidadeCotas) {
        ...
        List<Fiis> fiisSimulados = calculadoraV.simularFundoImobiliarioPerfil(new Fiis(aporte, prazo, quantidadeCotas), historico, 6);
        ...
        List<RendaFixa> resultados = calculadoraFixa.simularInvestimentoPerfil(capitalBg, aporteBg, prazo, 1);
